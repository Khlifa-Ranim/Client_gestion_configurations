...
const Dashboard = () => {
  ...
  const validate = (name, email, telephone, adresse, description) => {
    ...
    if (!telephone) {
      ...
      errors.telephone =
        "Telephone number that starts with 2, 5, or 9 and contains exactly 8 numbers ";
    }
          ...
          <Box m="20px">
            ...
            >
              ...
              >
                ...
                <Box>
                  <button
                    style={{ marginRight: "4px", backgroundColor: "#8A8FF7" }}
                    onMouseEnter={(e) => {
                      e.target.style.backgroundColor = "#9ba6a5";
                    }}
                    onMouseLeave={(e) => {
                      e.target.style.backgroundColor = "#8A8FF7";
                    }}
                    onClick={() => {
                      Navigate("/FetchUser");
                    }}
           ...
           {roleNames.includes("Admin") && (
            <>
              ...
              >
                <StatBox
                  ...
                  subtitle="Nombre Of versions Configurations"
                  icon={
                    <TrafficIcon
                      sx={{ color: colors.greenAccent[600], fontSize: "26px" }}
                    />
              ...
              {roleNames.includes("Admin") && (
                <Box
                  ...
                  overflow="auto"
                >
                  <h2>Recent Configurations Added</h2>
                  <Box
                    display="flex"
                    justifyContent="space-between"
                    alignItems="center"
            ...
            {/* Featch Configurations Versions */}
            {roleNames.includes("Client") && (
                    ...
                    >
                      <h2> Recent Configurations Versions Added</h2>
            ...
            {roleNames.includes("Employe") && (
                          ...
                          <Box
                            ...
                            overflow="auto"
                          >
                            <h2>Recent Permissions Added</h2>
                            <Box
                              display="flex"
                              justifyContent="space-between"
                              alignItems="center"
