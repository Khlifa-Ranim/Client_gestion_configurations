...
import { createSlice, createAsyncThunk } from "@reduxjs/toolkit";
  ...
  export const featchConfigurationtextById = createAsyncThunk(
    ...
    async (id, { rejectWithValue }) => {
      try {
        const response = await fetch(`http://localhost:5000/configurations_version/file/${id}`, {
          method: "GET",
          headers: {
  ...
  const FeatchConfigurationversionTextByIdSlice = createSlice({
  ...
  export default FeatchConfigurationversionTextByIdSlice.reducer
